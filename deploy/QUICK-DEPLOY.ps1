...
Write-Host ""
Write-Host "4. Bluehost Toolkit tab:"
Write-Host "   Upload bluehost/toolkit/index.html -> public_html/toolkit/index.html"
Write-Host "   Homepage nav link: https://thevesselcode.com/toolkit/"
Write-Host "   WordPress menu: deploy/BLUEHOST-HOMEPAGE-MENU.md"
Write-Host ""
Write-Host "5. Domain: Vercel Settings -> Domains -> app.thevesselcode.com"
Write-Host "   Bluehost DNS: CNAME app -> cname.vercel-dns.com"
Write-Host ""
Write-Host "6. Setup.exe: copy dist/*.exe to downloads/ then git push"
Write-Host ""
